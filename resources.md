...
## 4. Learning in Infinitesimal Non-Compositional Sketches
...
## 5. Landscape analysis for shallow neural networks: Complete classification of critical points for cubic activation and affine target functions
...
## 6. Spectral-Informed Neural Networks Outperform Spectral Methods in High-dimensional PDEs
...
## 9. Learning the Graphical Nature of Symmetries
...
## 11. Using Muon Rings for the Calibration of the Cherenkov Telescope Array: An Analytical Solution for the Dual-Mirror Telescope Using Vector Geometry
...
## 12. SciPhy Reinforcement Learning for Portfolio Optimization
...
## 13. Beyond the $d^{2.5}$-mixing bound for Dikin walks on polytopes
...
## 14. Can LLMs Build a MaxSAT Solver from Papers? The CoreForge Experience
...
## 15. Subgrid-Scale Parameterization in Burgers' Equation Using Structure-Preserving Neural Networks and Entropy Variables
...
## 16. Trajectory-Aware Flow Matching for Topology Optimisation

- Date: 2026-07-16
- Category: Geometry and Topology
- arXiv: https://arxiv.org/abs/2607.14652v1
- PDF: https://arxiv.org/pdf/2607.14652v1
- Infographic JSON: https://dutoaa.github.io/ai-in-math-progress/infographics/2026-07-16-arxiv-trajectory_aware_flow_matching_for_topology_optimisation_infographic.json

## 17. Building Shor's Algorithm in Lean: An Agentic Formalization of Quantum Attacks on RSA-2048 and P-256
...
## 18. Automatic Ordinary Differential Equations Discovery For Biological Systems Using Large Language Model Powered Agentic System
...
## 19. AI-Native Insurance for Agentic AI: Pricing, Underwriting, and End-to-End Automation
...
## 20. Blow-up Parameter Landscapes for Polynomial Dynamical Systems

- Date: 2026-07-15
- Category: Symbolic Computation
- arXiv: https://arxiv.org/abs/2607.14269v1
- PDF: https://arxiv.org/pdf/2607.14269v1
- Infographic JSON: https://dutoaa.github.io/ai-in-math-progress/infographics/2026-07-15-arxiv-blow_up_parameter_landscapes_for_polynomial_dynamical_systems_infographic.json
